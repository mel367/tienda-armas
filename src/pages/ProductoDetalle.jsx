      ...
      <div className="detalle-contenido">
        ...
        <div className="info-container">
          ...
          <div className="especificaciones">
            ...
            <ul>
              <li><strong>Calibre:</strong> {producto.calibre || 'N/A'}</li>
              <li><strong>Sistema de disparo:</strong> {producto.SistemaDeDisparo}</li>
              <li><strong>Longitud:</strong> {producto.longitud || 'N/A'}</li>
              <li><strong>Peso:</strong> {producto.peso || 'N/A'}</li>
              <li><strong>Capacidad:</strong> {producto.capacidad || 'N/A'}</li>
            </ul>
          </div>
